...
use App\Jobs\shipped_to_delivery;
   ...
   public function getAllIngredientsView(): View
    {
        ...
        }, 'childes.childes'])->where('position', 0)->where('organic_status',1)->get();

        return view('web-views.products.ingredients', [
            'categories' => CategoryManager::getPriorityWiseCategorySortQuery(query: $categories),
            'robotsMetaContentData' => $robotsMetaContentData
        ]);
    }
    ...
    public function checkout_details(Request $request)
    {
        if (
            ...
            Toastr::error(translate('please_login'));
    ...
    public function pay_offline_method_list(Request $request)
    {
     ...
     public function getPinCodeDetails(Request $request){
  	...
  	public function delivery_cost($delivery_pincode,$addresscheck){
        ...
        $totalShippingCost = 0;
        $groupid = CartManager::get_cart_group_ids();
