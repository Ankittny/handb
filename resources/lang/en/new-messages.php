...
return [
	...
	"Please fill refundable fields" => "Please fill refundable fields",
	"Please fill unit_price fields" => "Please fill unit price fields",
	"Please fill discount fields" => "Please fill discount fields",
	"Please fill discount_type fields" => "Please fill discount type fields",
	...
	"fill_in_the_required_details,_such_as_Display_Name,_Contact_Email,_and_App_Purpose" => "Fill in the required details  such as Display Name  Contact Email  and App Purpose",
	"Phone number with a minimum length requirement of 4 characters" => "Phone number with a minimum length requirement of 4 characters",
	"The phone has already been taken" => "The phone has already been taken",
	...
	"featured deal'nvOpzp; AND 1=1 OR (<'>iKO))," => "Featured deal nvOpzp  AND 1=1 OR (   iKO)) ",
	"if_disabled_this_category_will_be_hidden_from_the_category_wise_product_section_in_the_website_and_customer_app_in_the_homepage" => "If disabled this category will be hidden from the category wise product section in the website and customer app in the homepage",
	"Ingredients Status" => "Ingredients Status",
	"organic" => "Organic",
	"if_enabled_this_category_will_be_visible_from_the_category_wise_product_section_in_the_website_and_customer_app_in_the_homepage" => "If enabled this category will be visible from the category wise product section in the website and customer app in the homepage",
	"Ingredients" => "Ingredients",
	"Find_your_favourite_Ingredients_and_products" => "Find your favourite Ingredients and products",
	...
	"Features" => "Features",
	"Disclaimer field is optional." => "Disclaimer field is optional.",
	"Inefficient field is optional." => "Inefficient field is optional.",
	"Features are required!" => "Features are required!",
	"total_sub_category" => "Total sub category",
	"Ingredients are required!" => "Ingredients are required!",
	"How to Use" => "How to Use",
	"how_to_use!" => "How to use!",
	"weight_grams_is_required!" => "Weight grams is required!",
	"The weight grams field is required." => "The weight grams field is required.",
	"The how to use field is required." => "The how to use field is required.",
	...
	"shop_Address" => "Shop Address",
	"new-messages.The_pin_code_field_is_required" => "New-messages.The pin code field is required",
	"The_country_may_not_be_greater_than_100_characters" => "The country may not be greater than 100 characters",
	"The_country_field_must_be_a_string" => "The country field must be a string",
	"The_state_may_not_be_greater_than_50_characters" => "The state may not be greater than 50 characters",
	...
	"pincode not available" => "Pincode not available",
	...
	"The_state_field_must_be_a_string" => "The state field must be a string",
	"The_city_may_not_be_greater_than_100_characters" => "The city may not be greater than 100 characters",
	"The_city_field_must_be_a_string" => "The city field must be a string",
	"The_pin_code_field_is_required" => "The pin code field is required",
	...
	"<img src=x onerror=alert(XSS)>" => " img src=x onerror=alert(XSS) ",
	"<object data='data:text/html;base64,PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4='>" => " object data= data:text/html base64 PHNjcmlwdD5hbGVydCgnWFNTJyk8L3NjcmlwdD4=  ",
	"<iframe src='javascript:alert(XSS)'></iframe>" => " iframe src= javascript:alert(XSS)   /iframe ",
	"<input type='text' value='XSS' onfocus='alert(XSS)'/>" => " input type= text  value= XSS  onfocus= alert(XSS) / ",
	"<marquee onstart='alert(XSS)'>Text</marquee>" => " marquee onstart= alert(XSS)  Text /marquee ",
	"best_delivery_service,_highly_recommended" => "Best delivery service  highly recommended",
	...
	"add_new_employee" => "Add new employee",
	"Please fill sub_sub_category_id fields" => "Please fill sub sub category id fields",
	"Please fill features fields" => "Please fill features fields",
	...
	"HSN Code" => "HSN Code",
	"Return policy field is required." => "Return policy field is required.",
	...
	"FAQ_Get_All_Answers" => "FAQ Get All Answers",
	"test_mail" => "Test mail",
	"change_password" => "Change password",
	...
	"Please fill disclaimer fields" => "Please fill disclaimer fields",
	"HSN Master" => "HSN Master",
	"hsnCode" => "HsnCode",
	"hsn_code_under_gst" => "Hsn code under gst",
	"Hsn ID" => "Hsn ID",
	"hsn_list" => "Hsn list",
	"Hsn_List" => "Hsn List",
	"hsn_added_successfully" => "Hsn added successfully",
	"Update HSN Master" => "Update HSN Master",
	"hsn_updated_successfully" => "Hsn updated successfully",
	"hsn_deleted_successfully" => "Hsn deleted successfully",
	"vendor_product_List" => "Vendor product List",
	"discounted'" => "Discounted ",
	"latest'" => "Latest ",
	"best-selling'" => "Best-selling ",
	...
	"Get_Latest_Updates_by_Subscribing_to_Our_Newsletter" => "Get Latest Updates by Subscribing to Our Newsletter",
	"invalid_credential" => "Invalid credential",
	"enter_alt_tag" => "Enter alt tag",
	"Alt Tag" => "Alt Tag",
	...
	"Delivery_unavailable_in_this_country." => "Delivery unavailable in this country.",
	"pay P5H4K9ySBjpWMO" => "Pay P5H4K9ySBjpWMO",
	"search_by_payment_method_name" => "Search by payment method name",
	"pay P6WN1KGduV9BWd" => "Pay P6WN1KGduV9BWd",
	...
	"enter_slugs" => "Enter slugs",
	"Slug" => "Slug",
	"select_hsn_code" => "Select hsn code",
	...
	"most-favorite'" => "Most-favorite ",
	"most-favorite'A=0" => "Most-favorite A=0",
	...
	"Bulk Product Status" => "Bulk Product Status",
	"Select whether this product should be active or inactive in bulk." => "Select whether this product should be active or inactive in bulk.",
	...
	"Bulk_Order" => "Bulk Order",
	"Bulk_product_setup" => "Bulk product setup",
	"Bulk_Product_setup" => "Bulk Product setup",
	"product_variation_setupsdfsdf" => "Product variation setupsdfsdf",
	"bulk_product_setup" => "Bulk product setup",
