        ...
        <div class="navbar navbar-expand-md navbar-light">
            <div class="container-fluid ">
                ...
                <a class="navbar-brand d-none d-sm-block mr-3 flex-shrink-0 __min-w-7rem"
                   href="{{route('home')}}">
                    ...
                    <img class="__inline-11"
                         src="{{asset('public/assets/back-end/company/').'/'.$web_config['web_logo']['key']}}"
                         alt="{{$web_config['name']->value}}">
                </a>
                <a class="navbar-brand d-sm-none"
                   href="{{route('home')}}">
                    <img class="mobile-logo-img __inline-12"
                         src="{{asset('public/assets/back-end/company/').'/'.$web_config['mob_logo']['key']}}"
                         alt="{{$web_config['name']->value}}"/>
                </a>
                ...
                <div class="navbar-toolbar d-flex flex-shrink-0 align-items-center">
                    ...
                    @else
                        <div class="dropdown">
                             <a href="{{route('customer.auth.login')}}" class="navbar-tool {{Session::get('direction') === "rtl" ? 'mr-md-3' : 'ml-md-3'}}"
                                data-toggle="" aria-haspopup="false"
                               aria-expanded="false">
                                <div class="navbar-tool-icon-box bg-secondary">
                                    <div class="navbar-tool-icon-box bg-secondary">
