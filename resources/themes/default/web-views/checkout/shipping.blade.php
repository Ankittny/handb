                                            ...
                                            <div class="">
                                                <div class="mt-3">
                                                    <div class="row">
                                                        ...
                                                        <input type="hidden" id="current-login-user-name" name="current-login-user-name" value="{{ auth('customer')->check() ? auth('customer')->user()->f_name . ' ' . auth('customer')->user()->l_name : '' }}">
                                                        <input type="hidden" id="current-login-user-email" name="contact_person_email" value="{{ auth('customer')->check() ? auth('customer')->user()->email : '' }}">
                                                        <input type="hidden" id="current-login-user-phone" name="current-login-user-phone" value="{{ auth('customer')->check() ? auth('customer')->user()->phone : '' }}">
...
@push('script')
    ...
    //     function deleverycost(md, ss, d_pin, o_pin, cgm) {
    //        // alert("Requesting delivery cost...");
    //         if (md !== '' && ss !== '' && d_pin !== '' && o_pin !== '' && cgm !== '') {
    //             $.ajax({
    //                 url:"{{url('delivery-cost')}}",
    //                 type: 'GET',
    //                 data: {
    //                     md: md,
    //                     ss: ss,
    ...
    //                         location.reload();
    //                     } else {
    //                         console.log('Failed to retrieve shipping cost');
    //                     }
    //                 },
    ...
    //         }
    //     }
    // deleverycost('S', 'RTO', '201201', '201301', '50');
    </script>
    ...
    @if(getWebConfig('map_api_status') ==1 )
        <script src="https://maps.googleapis.com/maps/api/js?key={{getWebConfig('map_api_key')}}&callback=mapsShopping&loading=async&libraries=places&v=3.56" defer></script>
    @endif
@endpush
