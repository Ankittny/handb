                            ...
                            <div class="form-group">
                                <div class="d-flex gap-2 mb-2">
                                    <label class="title-color mb-0"
                                           for="discount_Type">{{ translate('HSN Code') }}</label>
                                </div>
                                @php
                                    $Hsncode = App\Models\Hsncode::select('hsn_code_under_gst','description')->get(); // Fetch data from the model
                                @endphp
                                <select class="js-select2-custom form-control action-get-request-onchange" name="hsn_code_under_gst" id="hsn_code_under_gst" onchange="handleSelectChange()">
                                    @foreach($Hsncode as $hsn)
                                    <option value="{{ $hsn->hsn_code_under_gst }}">{{ $hsn->hsn_code_under_gst." ".$hsn->description }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
