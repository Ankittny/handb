                ...
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    <a class="navbar-brand" href="{{route('admin.dashboard.index')}}" aria-label="Front">
                      ...
                      <img class="navbar-brand-logo-mini for-web-logo max-h-30"
                             src="{{asset('public/assets/back-end/company/').'/'.$eCommerceLogo['key']}}" alt="{{translate('logo')}}">
                    </a>
                    <button type="button"
...
<li class="navbar-vertical-aside-has-menu {{Request::is('admin/pos*')?'active':''}}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                                   title="{{translate('HSN Master')}}" href="{{route('admin.hsn.list')}}">
                                    <i class="tio-shopping nav-icon"></i>
                                    <span
                                        class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">{{translate('HSN Master')}}</span>
                                </a>
                            </li>
