                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <select class="js-select2-custom form-control action-get-request-onchange" name="category_id" id="categoryhsn_id"
                       ...
                       <div class="col-md-6 col-lg-4 col-xl-3 physical_product_show">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="weight(grams)"
                                       name="weight_grams">
                            </div>
                        </div>
                        <div class="col-md-9">
                        ...
                        <div class="col-md-6 col-lg-4 col-xl-3">
                            <div class="form-group">
                                ...
                                <input type="number" min="0" step="0.01"
                                       ...
                                       value="{{ old('tax') ?? 0 }}" class="form-control hsn_id">
                    ...
                    <div class="row align-items-end">
                        <div class="col-md-12">
                            ...
                            <label class="checkbox-inline">
                                <input type="checkbox" value="{{ $items->id }}" name="ingredients[]"> {{$items->name}}
                              </label> &nbsp;
                            @endforeach
                        </div>
                    </div>
