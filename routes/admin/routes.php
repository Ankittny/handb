...
use App\Enums\ViewPaths\Admin\{Cart,Blog};
...
use App\Http\Controllers\Admin\{ProfileController,BlogController};
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'products', 'as' => 'products.', 'middleware' => ['module:product_management']], function () {
        Route::controller(ProductController::class)->group(function () {
            ...
            Route::post(Product::HSNCODE[URI], 'gethsncode')->name('gethsncode');
    ...
    Route::group(['prefix' => 'orders', 'as' => 'orders.','middleware'=>['module:order_management']], function () {
        Route::controller(OrderController::class)->group(function () {
            ...
            Route::post(Order::RETURNCANCIL[URI], 'return_cancel')->name('return-cancel');
          	Route::post(Order::PRINTSLIP[URI],'printslip')->name('printslip');
    ...
    Route::group(['prefix' => 'hsn', 'as' => 'hsn.'], function () {
          Route::controller(HsnController::class)->group(function () {
               Route::get(Hsn::LIST[URI], 'list')->name('list');
               Route::get(Hsn::UPDATE[URI]. '/{id}', 'updateview')->name('update');
               Route::post(Hsn::ADD[URI], 'add')->name('add');
               Route::post(Hsn::CATID[URI], 'catIdData')->name('catId');
               Route::post(Hsn::UPDATEDATA[URI], 'updatedata')->name('updatedata');
