...
use App\Http\Controllers\Web\{WebController,BlogController};
...
Route::group(['prefix' => 'blog'],function(){
    Route::get('new-test',function(){
        return view('blog1.blog1');
    });
});

Route::group(['prefix' => 'blog-detail'],function(){
    Route::get('new-test-detail',function(){
        return view('blog1.blog1-detail');
    });
});
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::controller(WebController::class)->group(function () {
		...
		Route::get('ingredients', 'getAllIngredientsView')->name('ingredients');
    ...
    Route::controller(ProductListController::class)->group(function () {
        ...
        Route::get('ingredients-details', 'ingredients')->name('ingredients-details');
    });
...
Route::group(['prefix' => 'cart', 'as' => 'cart.', 'namespace' => 'Web'], function () {
    Route::controller(CartController::class)->group(function () {
        ...
        Route::post('change_quantity', 'changeQuantity')->name('change_quantity');
    });
});
